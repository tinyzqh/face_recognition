...
#建立一个基于CNN的人脸识别模型
class Model(object):
    FILE_PATH = '/home/hezhiqiang/PycharmProjects/model.h5/model.h5'   #模型进行存储和读取的地方
    ...
    def train_model(self):
        ...
        self.model.fit(self.dataset.X_train,self.dataset.Y_train,epochs=8,batch_size=20,initial_epoch=1,)
